...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_octn3af', 'template_8zihach', form.current, {
            publicKey: '9QE4Va-CtED6Z9Pr1',
          })
          .then(
            () => {
  ...
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact_container container grid">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card_data">
                mikesonowallah@gmail.com
              </span>
              <a href="" className="contact_button">
                Write me{" "}
                <ArrowRightAltOutlined className="contact_button_icon" />
              </a>
            </div>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card_data">+254702896093</span>
              <a href="https://wa.me/+254702896093" className="contact_button">
                Write me{" "}
                <ArrowRightAltOutlined className="contact_button_icon" />
              </a>
            </div>
            ...
            <div className="contact_card">
              ...
              <h3 className="contact_card_title">Call</h3>
              <span className="contact_card_data">+254702896093</span>
              <a href="" className="contact_button">
                Write me{" "}
                <ArrowRightAltOutlined className="contact_button_icon" />
        ...
        <div className="contact_content">
          <h3 className="contact_title">Tell me about your project Idea</h3>
